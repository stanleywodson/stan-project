import banner from "../../../images/banners/acenda-luz.jpg"
import g12 from "../../../images/banners/g12.jpg"
    ...
    return (
        <div id="default-carousel" className="relative w-full" data-carousel="slide">
            <div className="relative h-56 overflow-hidden rounded-lg md:h-[700px]">
                ...
                <div className="hidden duration-900 ease-in-out" data-carousel-item>
                    <img src={g12} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-cover" alt="..." />
                </div>
